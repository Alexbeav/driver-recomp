...
[![GitHub downloads (all assets, all releases)](https://img.shields.io/github/downloads/Alexbeav/driver-recomp/total)](https://github.com/Alexbeav/driver-recomp/releases)
[![GitHub downloads (latest release)](https://img.shields.io/github/downloads/Alexbeav/driver-recomp/latest/total)](https://github.com/Alexbeav/driver-recomp/releases/latest)
[![GitHub release](https://img.shields.io/github/v/release/Alexbeav/driver-recomp)](https://github.com/Alexbeav/driver-recomp/releases/latest)
<!-- /retcomm-readme-metrics -->

Static recompilation of **Driver** built on
[psxrecomp](https://github.com/Alexbeav/psxrecomp) and
[recomp-ui](https://github.com/mstan/recomp-ui).

A native recompilation setup host for Driver.
...
Zip prefix for CI artifacts: `Driver-Recomp`.
...
The `v0.3.3` source uses `Driver_Recompiled` in CMake, the setup relaunch, and the packager.
